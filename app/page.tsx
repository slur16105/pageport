    ...
    <main>
      ...
      <section className="faq-section" id="faq">
        ...
        <div className="faq-list">
          <details>
            <summary>회원가입 없이 어떻게 이용하나요?</summary>
            <p>
              상품을 고른 뒤 구매 이메일로 받은 6자리 인증번호를 입력하고 결제합니다. 아이디와 비밀번호는 만들지
              않습니다.
            </p>
          </details>
          <details>
            <summary>구매한 PDF는 어디서 받나요?</summary>
            <p>결제 완료 화면에서 바로 받을 수 있고, 입력한 이메일로도 다운로드 안내를 보내드립니다.</p>
          </details>
          <details>
            <summary>구매내역은 어떻게 확인하나요?</summary>
            <p>
              ‘파일 다시 받기’에서 구매 이메일을 인증하면 해당 이메일로 결제한 상품 목록을 확인할 수 있습니다.
              주문번호는 외울 필요가 없습니다.
            </p>
          </details>
          <details>
            <summary>다운로드 주소가 만료되면 다시 결제해야 하나요?</summary>
            <p>
              아닙니다. 주소는 24시간 또는 5회 다운로드 후 만료되지만, 구매 이메일을 다시 인증하면 새 주소를 받을 수
              있습니다.
            </p>
          </details>
          <details>
            <summary>구매 이메일을 잘못 입력했다면 어떻게 하나요?</summary>
            <p>
              결제 전에는 이메일을 수정할 수 있습니다. 결제 후에는 구매 기록을 자동으로 다른 이메일에 옮길 수 없으므로
              정식 운영 전에 마련할 고객지원 경로를 통해 확인이 필요합니다.
            </p>
          </details>
          <details>
